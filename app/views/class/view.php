...
{   ?>
                                                    <tr>
                                                        ...
                                                        <td><?php echo htmlentities($result->ClassNameNumeric);?>
                                                        </td>
                                                        <td><?php echo htmlentities($result->Section);?></td>
                                                        <td><?php echo htmlentities($result->CreationDate);?></td>
                                                        <td>
                                                            <a
                                                                href="update/<?php echo htmlentities($result->id);?>"><i
                                                                    class="fa fa-edit" title="Edit Record"></i> </a>
                                                                    <a
                                                                href="<?php echo URLROOT.'/classes/delete/'.htmlentities($result->id)?>"><i
        ...
        <!-- /.content-wrapper -->
         ...
         <script>
            //  function setid() {
            //     document.getElementById('delurl').text =  document.getElementById("getdelid").value;
            // }
              </script>
